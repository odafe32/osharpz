    ...
    <div className="relative -mx-4 flex items-center justify-between">
      ...
      <div className="flex w-full items-center justify-between px-4">
        <div>
          ...
          >
            <ul className="block text-center lg:flex lg:space-x-12">
        ...
        <div className="flex items-center justify-end pr-16 lg:pr-0">
          <Link
            href=""
            target="_blank"
            className="ease-in-up shadow-btn hover:shadow-btn-hover hidden rounded bg-primary px-3 py-3 text-base font-medium text-white transition  duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
          >
            Let's Chat
          </Link>
          <div>
